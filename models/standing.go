...
type ContestStanding struct {
	ContestID     string     `gorm:"type:uuid;primaryKey;index:idx_standings_contest,priority:1" json:"contestId"`
...
type ContestSolve struct {
	ContestID    string    `gorm:"type:uuid;primaryKey;index:idx_contest_solves_first_blood,priority:1;index:idx_contest_solves_lookup,priority:1" json:"contestId"`
	UserID       string    `gorm:"type:uuid;primaryKey;index:idx_contest_solves_lookup,priority:2" json:"userId"`
	ProblemID    string    `gorm:"type:uuid;primaryKey;index:idx_contest_solves_first_blood,priority:2;index:idx_contest_solves_lookup,priority:3" json:"problemId"`
...
type ContestUserProblem struct {
	ContestID    string     `gorm:"type:uuid;primaryKey;index:idx_cup_user_contest,priority:1" json:"contestId"`
	UserID       string     `gorm:"type:uuid;primaryKey;index:idx_cup_user_contest,priority:2" json:"userId"`
	ProblemID    string     `gorm:"type:uuid;primaryKey;index:idx_cup_problem,priority:1;index:idx_cup_problem_id" json:"problemId"`
...
type ContestProblemStat struct {
	ContestID      string `gorm:"type:uuid;primaryKey;index:idx_cps_contest,priority:1" json:"contestId"`
