...
type Submission struct {
	...
	Status     string    `gorm:"type:varchar(30);default:'Pending';index:idx_submissions_verdict;index:idx_submissions_penalty_lookup" json:"status"`
	ExecTime   *float64  `json:"execTime"`
	ExecMemory *float64  `json:"execMemory"`
	CreatedAt  time.Time `gorm:"type:timestamptz;default:now();index:idx_submissions_submitted_at,sort:desc;index:idx_submissions_contest_user_problem,sort:desc;index:idx_submissions_penalty_lookup" json:"createdAt"`
